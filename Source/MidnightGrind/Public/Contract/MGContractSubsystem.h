...
#include "Campaign/MGCampaignSubsystem.h"    // EMGObjectiveType
#include "BattlePass/MGBattlePassSubsystem.h" // EMGRewardType
...
// EMGObjectiveType - REMOVED (duplicate)
// Canonical definition in: Campaign/MGCampaignSubsystem.h
...
protected:
	void OnContractTick();
	void UpdateContractTimers(float MGDeltaTime);
