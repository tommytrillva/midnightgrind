 ...
 * void AMyVehicle::UpdateDriftVisuals(float MGDeltaTime)
 * {
...
protected:
	...
	/** Update FOV */
	void UpdateFOV(float MGDeltaTime);

	/** Update flash effect */
	void UpdateFlash(float MGDeltaTime);

	/** Update judder effect */
	void UpdateJudder(float MGDeltaTime);

	/** Update slow motion */
	void UpdateSlowMotion(float MGDeltaTime);

	/** Update continuous shake */
	void UpdateContinuousShake(float MGDeltaTime);

	/** Update custom shake */
	void UpdateCustomShake(float MGDeltaTime);
