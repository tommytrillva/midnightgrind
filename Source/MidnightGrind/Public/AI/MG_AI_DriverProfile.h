...
#include "MG_AI_DriverProfile.generated.h"
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Aggression")
	void UpdateAggressionState(float MGDeltaTime, int32 CurrentPosition, bool bUnderPressure, bool bApplyingPressure);
