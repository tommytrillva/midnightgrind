...
// EMGTrackSurface: Canonical definition in Tire/MGTireSubsystem.h (included above)
// EMGTrackEnvironment: Canonical definition in TrackEditor/MGTrackEditorSubsystem.h (included above)
