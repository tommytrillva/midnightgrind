 ...
 * @brief Spline-based track definition for racing line and boundaries.
 *
 * AMGTrackSpline provides a spline-based representation of a race track including:
 * - Racing line spline for optimal path guidance
 * - Inner and outer boundary splines for track limits
 * - Per-segment track properties (width, surface type, hazards)
 *
 * Used by AI for pathfinding, physics for surface detection, and respawn systems
 * for recovery positioning.
 *
 * @see AMGRacingLineActor for standalone racing line visualization
 * @see AMGTrackBoundaryActor for boundary collision handling
 */
