...
/**
 * @file MGCheckpoint.h
 * @brief Checkpoint actors for race tracking and lap counting.
 *
 * Defines AMGCheckpoint and AMGStartFinishLine actors that are placed in the world
 * to track vehicle progression through races. Checkpoints detect vehicle overlap
 * and report timing data to the race system.
 *
 * @see UMGTrackSubsystem for checkpoint registration and race timing
 * @see MGCheckpointActor.h for the alternate checkpoint implementation
 */
...
/**
 * Delegate broadcast when a vehicle passes through this checkpoint.
 * @param Vehicle The vehicle that triggered the checkpoint
 * @param CheckpointIndex The index of this checkpoint in the track sequence
 */
