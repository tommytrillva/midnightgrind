...
/**
 * @brief Wrapper for TArray<FMGAudioReflection> to support UPROPERTY in TMap.
 */
USTRUCT(BlueprintType)
struct FMGAudioReflectionArray
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TMap<FName, FMGAudioReflectionArray> SourceReflections;
