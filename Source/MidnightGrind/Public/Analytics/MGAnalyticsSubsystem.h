...
/**
 * @brief Wrapper for TArray<FMGFunnelStep> to support UPROPERTY in TMap.
 */
USTRUCT(BlueprintType)
struct FMGFunnelStepArray
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<FMGFunnelStep> Steps;
};
...
protected:
	...
	UPROPERTY()
	TMap<FString, FMGFunnelStepArray> FunnelData;
