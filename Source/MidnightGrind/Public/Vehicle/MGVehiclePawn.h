...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Input")
	int32 MGInputMappingPriority = 0;
...
protected:
	 ...
	 */
	virtual void UpdateRuntimeState(float MGDeltaTime);
	 ...
	 * @param DeltaTime Frame delta time in seconds.
	 */
	virtual void UpdateCamera(float MGDeltaTime);
	 ...
	 * @param DeltaTime Frame delta time in seconds.
	 */
	virtual void UpdateAudio(float MGDeltaTime);
	 ...
	 * @param DeltaTime Frame delta time in seconds.
	 */
	virtual void UpdateVFX(float MGDeltaTime);
