...
// EMGTuningCategory - REMOVED (duplicate)
// Canonical definition in: Tuning/MGTuningSubsystem.h
...
// MOVED TO Dyno/MGDynoSubsystem.h
// FMGDynoDataPoint is now defined in the canonical dyno subsystem header.
// Include "Dyno/MGDynoSubsystem.h" to use FMGDynoDataPoint.
/*
...
protected:
	...
	void TickDynoSession(FGuid SessionID, float MGDeltaTime);
