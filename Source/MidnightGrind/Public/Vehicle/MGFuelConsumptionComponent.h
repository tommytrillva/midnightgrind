...
protected:
	 ...
	 */
	virtual float CalculateFrameConsumption(float MGDeltaTime);

	/**
	 * @brief Update driving style metrics
	 * @param DeltaTime Frame delta time
	 */
	virtual void UpdateDrivingStyleMetrics(float MGDeltaTime);

	/**
	 * @brief Update fuel starvation simulation
	 * @param DeltaTime Frame delta time
	 */
	virtual void UpdateFuelStarvation(float MGDeltaTime);
	 ...
	 */
	virtual void UpdateTelemetry(float MGDeltaTime, float FrameConsumption);
