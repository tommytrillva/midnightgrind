...
// EMGDamageZone - REMOVED (duplicate)
...
// MOVED TO Damage/MG_DMG_Subsystem.h
// FMGComponentDamageState is now defined in the canonical damage subsystem header.
// Include "Damage/MG_DMG_Subsystem.h" to use FMGComponentDamageState.
/*
...
protected:
	...
	/** Update auto-repair */
	void UpdateAutoRepair(float MGDeltaTime);

	/** Update ongoing repairs */
	void UpdateRepairs(float MGDeltaTime);
