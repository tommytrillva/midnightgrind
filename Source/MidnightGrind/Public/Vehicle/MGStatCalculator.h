 ...
 * FMGVehicleSpecs Stats = UMGStatCalculator::CalculateAllStats(VehicleData, BaseModel);
 *
 ...
 * @note Renamed from UMGPartData to avoid conflict with FMGPartData struct in MGGarageSubsystem.h
 */
UCLASS(BlueprintType)
class MIDNIGHTGRIND_API UMGPartDataAsset : public UDataAsset
{
	GENERATED_BODY()
 ...
 * @see FMGVehicleSpecs Output statistics structure
 */
UCLASS(BlueprintType)
...
public:
	 ...
	 * populates a complete FMGVehicleSpecs structure. This is the primary
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Vehicle|Stats")
	static FMGVehicleSpecs CalculateAllStats(const FMGVehicleData& Vehicle, const UMGVehicleModelData* BaseModel);
	 ...
	 *
	 * Looks up the UMGPartDataAsset asset from the asset registry using
	...
	static UMGPartDataAsset* GetPartData(FName PartID);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Vehicle|Parts")
	static bool IsPartCompatible(const UMGPartDataAsset* Part, FName VehicleModelID, const FMGVehicleData& Vehicle);
