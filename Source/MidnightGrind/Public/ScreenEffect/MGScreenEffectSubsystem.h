...
public:
    ...
    void UpdateEffects(float MGDeltaTime);
...
protected:
    ...
    void UpdateActiveEffects(float MGDeltaTime);
    void UpdateShake(float MGDeltaTime);
    void UpdateTransition(float MGDeltaTime);
