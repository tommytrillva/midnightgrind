...
/**
 * @brief Wrapper for TArray<FPremiumPayment> to support UPROPERTY in TMap.
 */
USTRUCT(BlueprintType)
struct FMGPremiumPaymentArray
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<FPremiumPayment> Payments;
};
...
protected:
    ...
    UPROPERTY()
    TMap<FString, FMGPremiumPaymentArray> PaymentHistories;
