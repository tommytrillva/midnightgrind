...
// This file now uses FMGTitleDisplayProfile for title/banner display settings.

/**
 * @brief Player title and banner display settings
 *
 * Controls what cosmetic identity elements (titles, banners, nameplates) are shown
 * and how they're configured when other players view this player's profile or
 * see them in-game. This is separate from the full FMGPlayerProfile in ProfileManager.
 */
USTRUCT(BlueprintType)
struct FMGTitleDisplayProfile
{
	GENERATED_BODY()
...
/**
 * @brief Saved title/banner preset
 *
 * Allows players to save complete title and banner configurations and
...
struct FMGTitlePreset
{
	...
	/// Complete title display configuration stored in this preset
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FMGTitleDisplayProfile Profile;
};
...
public:
	...
	/** @brief Get the complete current title display profile configuration */
	UFUNCTION(BlueprintPure, Category = "Titles|Profile")
	FMGTitleDisplayProfile GetProfile() const { return CurrentProfile; }

	/**
	 * @brief Apply a complete title display profile configuration
	 * @param Profile The title display settings to apply
	 */
	UFUNCTION(BlueprintCallable, Category = "Titles|Profile")
	void SetProfile(const FMGTitleDisplayProfile& Profile);
...
protected:
	...
	/// Current title display profile configuration
	UPROPERTY()
	FMGTitleDisplayProfile CurrentProfile;
