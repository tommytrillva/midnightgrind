...
protected:
	...
	void UpdateAllTires(float MGDeltaTime);

	/** Update temperature for a single tire based on driving */
	void UpdateTireTemperature(FMGTireState& Tire, const FMGTireCompoundData& Compound, float MGDeltaTime);

	/** Update wear for a single tire based on driving */
	void UpdateTireWear(FMGTireState& Tire, const FMGTireCompoundData& Compound, float MGDeltaTime);
