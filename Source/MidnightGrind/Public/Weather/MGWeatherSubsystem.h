...
protected:
	...
	void UpdateWeatherTransition(float MGDeltaTime);

	/// Advances game time and checks for period changes
	void UpdateTimeProgression(float MGDeltaTime);

	/// Advances lighting transition and applies interpolated values
	void UpdateLightingTransition(float MGDeltaTime);
	...
	void UpdateLightning(float MGDeltaTime);
