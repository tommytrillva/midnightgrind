...
#include "Racing/MGRaceModeSubsystem.h" // FMGRaceConfig defined here
...
// FMGRaceConfig is defined in Racing/MGRaceModeSubsystem.h
...
protected:
	...
	void UpdateRaceTiming(float MGDeltaTime);
