...
/**
 * FMGFrameMetrics - Detailed timing data for a single frame.
 *
 ...
 * NOTE: Renamed from FFrameMetrics to avoid conflict with engine's FFrameMetrics
 */
USTRUCT(BlueprintType)
struct FMGFrameMetrics
{
    GENERATED_BODY()
...
public:
    ...
    FMGFrameMetrics GetCurrentFrameMetrics() const { return CurrentFrameMetrics; }
...
private:
    UPROPERTY()
    FMGFrameMetrics CurrentFrameMetrics;
