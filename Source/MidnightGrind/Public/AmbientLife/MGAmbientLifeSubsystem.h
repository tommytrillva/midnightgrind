...
// EMGTrafficDensity - defined in Core/MGSharedTypes.h
...
// FMGCrowdZone - defined in CrowdAudio/MGCrowdAudioSubsystem.h
...
protected:
	 ...
	 */
	void UpdateAmbientLife(float MGDeltaTime);

	/**
	 * @brief Updates crowd zone populations
	 * @param DeltaTime Time since last update
	 */
	void UpdateCrowds(float MGDeltaTime);
