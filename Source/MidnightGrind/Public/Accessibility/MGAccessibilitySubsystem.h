...
public:
	...
	void SetAccessibilitySettings(const FMGAccessibilitySettings& Settings);
	...
	FMGAccessibilitySettings GetAccessibilitySettings() const { return CurrentSettings; }
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Presets")
	...
	void SetColorBlindMode(EMGColorBlindMode Mode, float Intensity = 1.0f);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Visual")
	void SetTextSize(EMGTextSize Size);
	...
	FLinearColor GetAccessibleColor(FLinearColor OriginalColor) const;
	...
	void SetSubtitles(bool bEnabled, EMGTextSize Size = EMGTextSize::Medium);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Audio")
	void SetVisualizeAudio(bool bEnabled);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Controls")
	void SetAutoSteering(bool bEnabled);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Controls")
	void SetOneHandedMode(bool bEnabled);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Controls")
	void RemapInput(FName ActionName, FKey NewKey, bool bIsGamepad = false);
	...
	TArray<FMGInputRemapping> GetInputRemappings() const { return InputRemappings; }

	/**
	 * @brief Resets all input bindings to defaults
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Controls")
	void ResetInputRemappings();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Screen Reader")
	void Speak(const FString& Text, bool bInterrupt = false);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Accessibility|Screen Reader")
	void SpeakUIElement(const FString& ElementType, const FString& ElementName, const FString& Description);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Accessibility|Screen Reader")
	bool IsScreenReaderActive() const { return CurrentSettings.bScreenReaderEnabled; }
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Accessibility|Presets")
