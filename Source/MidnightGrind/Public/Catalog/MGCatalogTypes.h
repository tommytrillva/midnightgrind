...
#include "Content/MGVehicleContentAssets.h" // For FMGVehicleUnlockRequirements
...
// EMGPerformanceClass - defined in Core/MGSharedTypes.h
// Performance classes: D (Entry), C (Street), B (Sport), A (Performance), S (Super), X (Hyper)
...
// EMGDrivetrain - defined in Core/MGSharedTypes.h
...
// FMGVehicleUnlockRequirements - defined in Content/MGVehicleContentAssets.h
// Canonical location for vehicle unlock requirements including level, reputation,
// achievements, and prerequisite vehicle ownership.
