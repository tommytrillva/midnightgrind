...
#include "MG_DMG_Subsystem.generated.h"
...
// EMGDamageZone - defined in Core/MGSharedTypes.h
// Zone layout: FrontLeft, FrontCenter, FrontRight, SideLeft, SideRight, RearLeft, RearCenter, RearRight, Roof, Underbody
...
/**
 * @brief Wrapper for TMap<EMGDamageZone, FMGDeformationData> to support UPROPERTY in TMap.
 */
USTRUCT(BlueprintType)
struct FMGZoneDeformationMap
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TMap<EMGDamageZone, FMGDeformationData> ZoneData;
};
...
protected:
	...
	UPROPERTY()
	TMap<FName, FMGZoneDeformationMap> VehicleDeformation;
