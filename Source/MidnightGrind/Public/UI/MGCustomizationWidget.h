...
public:
	...
	FMGVehicleSpecs GetCurrentVehicleStats() const;

	/** Get preview stats (with selected part applied) */
	UFUNCTION(BlueprintPure, Category = "Customization|Stats")
	FMGVehicleSpecs GetPreviewVehicleStats() const;
...
private:
	...
	void UpdateCameraInterpolation(float MGDeltaTime);
	...
	mutable FMGVehicleSpecs CachedCurrentStats;
};
