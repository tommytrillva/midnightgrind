...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Stunt|Air")
	void UpdateAirState(FVector CurrentPosition, FRotator CurrentRotation, float MGDeltaTime);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Stunt|TwoWheel")
	void UpdateTwoWheelDriving(float Distance, float TiltAngle, float MGDeltaTime);
