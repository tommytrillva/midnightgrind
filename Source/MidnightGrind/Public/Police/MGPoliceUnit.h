...
protected:
	 ...
	 */
	virtual void UpdatePatrol(float MGDeltaTime);

	/**
	 * @brief Update pursuit behavior (chasing target).
	 * @param DeltaTime Time since last update
	 */
	virtual void UpdatePursuit(float MGDeltaTime);

	/**
	 * @brief Update ramming behavior.
	 * @param DeltaTime Time since last update
	 */
	virtual void UpdateRamming(float MGDeltaTime);

	/**
	 * @brief Update boxing behavior (surrounding target).
	 * @param DeltaTime Time since last update
	 */
	virtual void UpdateBoxing(float MGDeltaTime);

	/**
	 * @brief Update PIT maneuver behavior.
	 * @param DeltaTime Time since last update
	 */
	virtual void UpdatePIT(float MGDeltaTime);

	/**
	 * @brief Update intercept behavior.
	 * @param DeltaTime Time since last update
	 */
	virtual void UpdateIntercept(float MGDeltaTime);

	/**
	 * @brief Update disabled behavior (coast to stop).
	 * @param DeltaTime Time since last update
	 */
	virtual void UpdateDisabled(float MGDeltaTime);
