...
/**
 * @brief Wrapper for TArray<FMGBlackMarketItem> to support UPROPERTY in TMap.
 */
USTRUCT(BlueprintType)
struct FMGBlackMarketItemArray
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<FMGBlackMarketItem> Items;
};
...
protected:
	...
	UPROPERTY()
	TMap<FName, FMGBlackMarketItemArray> DealerInventories;
