...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Powerup|Projectiles")
	void UpdateProjectiles(float MGDeltaTime);
	...
	UFUNCTION(BlueprintCallable, Category = "Powerup|Hazards")
	void UpdateHazards(float MGDeltaTime);
	...
	void UpdatePowerups(float MGDeltaTime);

	UFUNCTION(BlueprintCallable, Category = "Powerup|Update")
	void UpdateSpawnPoints(float MGDeltaTime);
...
protected:
	void TickPowerups(float MGDeltaTime);
