...
struct FMGFeatureFlag
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Rollout")
...
struct FMGExperimentAssignment
{
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Assignment")
	FString ExperimentID;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Tracking")
	bool bExposed = false;
