...
void UMGPowerupSubsystem::UpdateProjectiles(float MGDeltaTime)
{
...
void UMGPowerupSubsystem::UpdateHazards(float MGDeltaTime)
{
...
void UMGPowerupSubsystem::UpdatePowerups(float MGDeltaTime)
{
...
void UMGPowerupSubsystem::UpdateSpawnPoints(float MGDeltaTime)
{
	for (auto& Pair : SpawnPoints)
	{
...
void UMGPowerupSubsystem::TickPowerups(float MGDeltaTime)
{
