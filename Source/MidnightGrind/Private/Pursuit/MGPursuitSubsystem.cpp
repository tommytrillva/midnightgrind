...
void UMGPursuitSubsystem::UpdatePursuit(const FString& PlayerId, FVector PlayerLocation, FVector PlayerVelocity, float MGDeltaTime)
{
	FMGPursuitStatus* Status = ActivePursuits.Find(PlayerId);
	if (!Status)
	{
...
void UMGPursuitSubsystem::UpdateUnitAI(const FString& PlayerId, float MGDeltaTime)
{
	FMGPursuitStatus* Status = ActivePursuits.Find(PlayerId);
	if (!Status)
	{
...
void UMGPursuitSubsystem::TickPursuit(float MGDeltaTime)
{
...
void UMGPursuitSubsystem::UpdateEscapeProgress(const FString& PlayerId, FVector PlayerLocation, float MGDeltaTime)
{
	FMGPursuitStatus* Status = ActivePursuits.Find(PlayerId);
	if (!Status)
	{
...
void UMGPursuitSubsystem::UpdateBustedProgress(const FString& PlayerId, float MGDeltaTime)
{
	FMGPursuitStatus* Status = ActivePursuits.Find(PlayerId);
	if (!Status)
	{
