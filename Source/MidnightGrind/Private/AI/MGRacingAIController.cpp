...
void FMGAIDriverConfig::GenerateFromDifficulty(EMGAIDifficulty InDifficulty)
{
...
void AMGRacingAIController::Tick(float MGDeltaTime)
{
...
void AMGRacingAIController::SetDriverProfile(const FMGAIDriverConfig& Profile)
{
...
void AMGRacingAIController::UpdateState(float MGDeltaTime)
{
...
void AMGRacingAIController::UpdateNavigation(float MGDeltaTime)
{
...
void AMGRacingAIController::UpdateVehicleInputs(float MGDeltaTime)
{
	if (!ControlledVehicle)
	{
		return;
