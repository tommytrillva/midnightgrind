...
/**
 * @file MGCheckpointSubsystem.cpp
 * @brief Implementation of the Checkpoint Subsystem for race timing, laps, sectors,
...
void UMGCheckpointSubsystem::UpdateCheckpointDetection(FVector PlayerLocation, FVector PlayerVelocity, float MGDeltaTime)
{
	if (!bRaceActive || bRacePaused || !bLayoutLoaded)
	{
		return;
...
void UMGCheckpointSubsystem::TickRace(float MGDeltaTime)
{
