...
void UMGRetroRenderingComponent::TickComponent(float MGDeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGRetroRenderingComponent::ConfigurePostProcess()
{
	...
	if (PPVolume)
	{
		...
		PPVolume->Settings.bOverride_FilmGrainIntensity = RenderConfig.bEnableNoise;
		PPVolume->Settings.FilmGrainIntensity = RenderConfig.NoiseIntensity;

		PPVolume->Settings.bOverride_VignetteIntensity = RenderConfig.bEnableVignette;
		PPVolume->Settings.VignetteIntensity = RenderConfig.VignetteIntensity;
