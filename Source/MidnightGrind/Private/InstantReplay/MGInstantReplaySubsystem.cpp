...
/**
 * @file MGInstantReplaySubsystem.cpp
 * @brief Implementation of the instant replay and highlight reel system.
 *
 * @see MGInstantReplaySubsystem.h for full documentation
 */
...
// Update
void UMGInstantReplaySubsystem::UpdateReplaySystem(float MGDeltaTime)
{
...
// Protected
void UMGInstantReplaySubsystem::TickRecording(float MGDeltaTime)
{
	if (CurrentBuffer.Status != EMGReplayStatus::Recording)
	{
		return;
...
void UMGInstantReplaySubsystem::TickPlayback(float MGDeltaTime)
{
	if (PlaybackState.Status != EMGReplayStatus::Playing)
	{
		return;
