...
/**
 * @file MGRaceFlowSubsystem.cpp
 * @brief Implementation of the Race Flow Subsystem
 *
 * This file implements the central race lifecycle orchestrator.
 * It handles state machine transitions, level loading, vehicle spawning,
 * reward processing, and coordination between racing subsystems.
 *
 * @see MGRaceFlowSubsystem.h for class documentation
 */
