...
/**
 * @file MGRaceHistorySubsystem.cpp
 * @brief Implementation of the Race History Subsystem
 *
 * Handles recording race results, updating statistics, managing personal bests,
 * and persisting race history to disk as JSON.
 *
 * @see MGRaceHistorySubsystem.h for class documentation
 */
