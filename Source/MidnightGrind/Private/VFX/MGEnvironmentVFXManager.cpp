...
void AMGEnvironmentVFXManager::Tick(float MGDeltaTime)
{
...
void AMGEnvironmentVFXManager::UpdateWeather(float MGDeltaTime)
{
...
void AMGEnvironmentVFXManager::UpdateTimeOfDay(float MGDeltaTime)
{
	if (bTimePaused)
	{
		return;
