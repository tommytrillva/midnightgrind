...
void UMGCameraVFXComponent::TickComponent(float MGDeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGCameraVFXComponent::UpdateFOV(float MGDeltaTime)
{
...
void UMGCameraVFXComponent::UpdateFlash(float MGDeltaTime)
{
...
void UMGCameraVFXComponent::UpdateJudder(float MGDeltaTime)
{
	if (!bJudderActive)
	{
		return;
...
void UMGCameraVFXComponent::UpdateSlowMotion(float MGDeltaTime)
{
...
void UMGCameraVFXComponent::UpdateContinuousShake(float MGDeltaTime)
{
...
void UMGCameraVFXComponent::UpdateCustomShake(float MGDeltaTime)
{
