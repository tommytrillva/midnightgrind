...
/**
 * @file MGTrackSpline.cpp
 * @brief Implementation of spline-based track definition actor.
 *
 * Provides racing line queries, boundary spline generation, segment-based
 * track properties, and AI pathfinding support.
 */
