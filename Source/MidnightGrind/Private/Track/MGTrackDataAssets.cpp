...
/**
 * @file MGTrackDataAssets.cpp
 * @brief Implementation of track configuration data assets.
 *
 * Provides utility functions for track data assets including grid position
 * queries, sector lookups, medal calculations, and minimap UV conversion.
 * Also contains default track configurations for the Downtown district.
 */

#include "Track/MGTrackDataAssets.h"
#include "World/MGWorldSubsystem.h"
