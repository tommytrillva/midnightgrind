...
/**
 * @file MGTrackSubsystem.cpp
 * @brief Implementation of track management world subsystem.
 *
 * Handles checkpoint registration, racer progress tracking, lap/sector timing,
 * position calculations, wrong-way detection, and track record management.
 */
...
void UMGTrackSubsystem::Tick(float MGDeltaTime)
{
	// Update race timer
