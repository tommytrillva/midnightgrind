...
/**
 * @file MGRacingLineActor.cpp
 * @brief Implementation of racing line visualization and query actor.
 *
 * Provides spline-based optimal racing path with ideal speed data,
 * braking/acceleration zones, and deviation calculations for AI guidance.
 */
