...
/**
 * @file MGTireSubsystem.cpp
 * @brief Implementation of tire physics simulation and management subsystem.
 *
 * Handles tire wear, temperature, grip calculations, compound characteristics,
 * surface interactions, and tire change operations for all registered vehicles.
 */
...
void UMGTireSubsystem::UpdateAllTires(float MGDeltaTime)
{
...
void UMGTireSubsystem::UpdateTireTemperature(FMGTireState& Tire, const FMGTireCompoundData& Compound, float MGDeltaTime)
{
	// Heat from slip
...
void UMGTireSubsystem::UpdateTireWear(FMGTireState& Tire, const FMGTireCompoundData& Compound, float MGDeltaTime)
{
