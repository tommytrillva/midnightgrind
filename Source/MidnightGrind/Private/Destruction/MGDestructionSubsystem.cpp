...
void UMGDestructionSubsystem::UpdateDestruction(float MGDeltaTime)
{
...
void UMGDestructionSubsystem::TickDestruction(float MGDeltaTime)
{
	UpdateDestruction(DeltaTime);
}

void UMGDestructionSubsystem::UpdateCombos(float MGDeltaTime)
{
...
void UMGDestructionSubsystem::UpdateRespawns(float MGDeltaTime)
{
	for (auto& Pair : Instances)
	{
...
void UMGDestructionSubsystem::UpdateChainReactions(float MGDeltaTime)
{
