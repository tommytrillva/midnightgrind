...
/**
 * @file MGRacingPerformanceConfig.cpp
 * @brief Implementation of Racing Performance Configuration Data Asset.
 *
 * Initializes performance profiles for different platform tiers (Low, Medium,
 * High, Ultra) with appropriate budgets for vehicles, VFX, physics, audio,
 * AI, and streaming. Includes automatic platform tier detection based on
 * available hardware resources.
 *
 * @see UMGRacingPerformanceConfig
 */
