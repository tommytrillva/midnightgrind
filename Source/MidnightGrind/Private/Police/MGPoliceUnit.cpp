...
void AMGPoliceUnit::Tick(float MGDeltaTime)
{
...
void AMGPoliceUnit::UpdatePatrol(float MGDeltaTime)
{
...
void AMGPoliceUnit::UpdatePursuit(float MGDeltaTime)
{
	if (!PursuitTarget.IsValid())
	{
...
void AMGPoliceUnit::UpdateRamming(float MGDeltaTime)
{
	if (!PursuitTarget.IsValid())
	{
		SetPoliceState(EMGPoliceState::Pursuing);
...
void AMGPoliceUnit::UpdateBoxing(float MGDeltaTime)
{
	if (!PursuitTarget.IsValid())
	{
		SetPoliceState(EMGPoliceState::Pursuing);
...
void AMGPoliceUnit::UpdatePIT(float MGDeltaTime)
{
	if (!PursuitTarget.IsValid())
	{
		SetPoliceState(EMGPoliceState::Pursuing);
...
void AMGPoliceUnit::UpdateIntercept(float MGDeltaTime)
{
	if (!PursuitTarget.IsValid())
	{
		SetPoliceState(EMGPoliceState::Pursuing);
...
void AMGPoliceUnit::UpdateDisabled(float MGDeltaTime)
{
