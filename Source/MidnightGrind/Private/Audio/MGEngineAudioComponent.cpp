...
void UMGEngineAudioComponent::TickComponent(float MGDeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGEngineAudioComponent::UpdateLayers(float MGDeltaTime)
{
...
void UMGEngineAudioComponent::UpdateExhaustPops(float MGDeltaTime)
{
