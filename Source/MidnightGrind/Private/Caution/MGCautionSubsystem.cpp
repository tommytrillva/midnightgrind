...
/**
 * @file MGCautionSubsystem.cpp
 * @brief Implementation of the Caution Subsystem for race caution periods,
 *        safety car procedures, VSC, and flag management.
 */
...
void UMGCautionSubsystem::UpdateSafetyCar(float MGDeltaTime)
{
...
void UMGCautionSubsystem::UpdateVSC(float MGDeltaTime)
{
...
void UMGCautionSubsystem::UpdateRestartProcedure(float MGDeltaTime)
{
