...
void UMGAirtimeSubsystem::UpdateJump(const FString& PlayerId, FVector Position, FVector Velocity, FRotator Rotation, bool bIsGrounded, float MGDeltaTime)
{
...
void UMGAirtimeSubsystem::DetectTricks(const FString& PlayerId, FRotator DeltaRotation, float MGDeltaTime)
{
	FMGActiveJump* Jump = ActiveJumps.Find(PlayerId);
	if (!Jump || !Jump->bIsAirborne)
	{
...
// Update
void UMGAirtimeSubsystem::UpdateAirtimeSystem(float MGDeltaTime)
{
	TickAirtime(DeltaTime);
}

// Protected
void UMGAirtimeSubsystem::TickAirtime(float MGDeltaTime)
{
	UpdateActiveJumps(DeltaTime);
}

void UMGAirtimeSubsystem::UpdateActiveJumps(float MGDeltaTime)
{
...
void UMGAirtimeSubsystem::UpdateJumpMetrics(FMGActiveJump& Jump, FVector Position, float MGDeltaTime)
{
