...
FMGVehicleSpecs UMGCustomizationWidget::GetCurrentVehicleStats() const
{
...
FMGVehicleSpecs UMGCustomizationWidget::GetPreviewVehicleStats() const
{
	// Calculate preview stats with selected part
	FMGVehicleSpecs Stats = GetCurrentVehicleStats();
...
{
	FMGVehicleSpecs Stats = GetPreviewVehicleStats();
	return UMGStatCalculator::CalculatePerformanceIndex(Stats);
}
...
FMGPartComparison UMGCustomizationWidget::CalculatePartComparison(const FGuid& PartID) const
{
	...
	FMGVehicleSpecs CurrentStats = GetCurrentVehicleStats();
	FMGVehicleSpecs PreviewStats = GetPreviewVehicleStats();
...
void UMGCustomizationWidget::UpdateCameraInterpolation(float MGDeltaTime)
{
	if (!bIsCameraInterpolating)
	{
		return;
