...
void UMGScreenEffectSubsystem::UpdateEffects(float MGDeltaTime)
{
    if (!bEffectsEnabled)
    {
        return;
...
void UMGScreenEffectSubsystem::UpdateActiveEffects(float MGDeltaTime)
{
...
void UMGScreenEffectSubsystem::UpdateShake(float MGDeltaTime)
{
    if (!bShakeActive)
    {
...
void UMGScreenEffectSubsystem::UpdateTransition(float MGDeltaTime)
{
    if (!bTransitioning)
    {
        return;
