...
void UMGFuelSubsystem::UpdateRefueling(float MGDeltaTime)
{
...
void UMGFuelSubsystem::UpdateFuelConsumption(FName VehicleID, float Throttle, float Speed, float RPM, int32 Gear, bool bNitroActive, float MGDeltaTime)
{
