...
void UMGAerodynamicsSubsystem::UpdateVehicleAero(const FString& VehicleId, FVector Position, FVector Velocity, float MGDeltaTime)
{
	FMGVehicleAeroState* State = VehicleStates.Find(VehicleId);
	if (!State)
	{
...
void UMGAerodynamicsSubsystem::UpdateAerodynamics(float MGDeltaTime)
{
...
void UMGAerodynamicsSubsystem::TickAerodynamics(float MGDeltaTime)
{
	UpdateAerodynamics(DeltaTime);
}

void UMGAerodynamicsSubsystem::UpdateSlipstreams(float MGDeltaTime)
{
...
void UMGAerodynamicsSubsystem::UpdateWindEffects(float MGDeltaTime)
{
...
void UMGAerodynamicsSubsystem::CalculateAeroForces(const FString& VehicleId, float MGDeltaTime)
{
...
void UMGAerodynamicsSubsystem::UpdateSlipstreamState(FMGSlipstreamSession& Session, float Distance, float MGDeltaTime)
{
