...
void UMGSpeedtrapSubsystem::UpdateSpeedtrapDetection(const FString& PlayerId, FVector Location, FVector Velocity, float MGDeltaTime)
{
...
void UMGSpeedtrapSubsystem::UpdateActiveZone(const FString& PlayerId, float Speed, float MGDeltaTime)
{
	FMGActiveSpeedtrap* Active = ActiveSpeedtraps.Find(PlayerId);
	if (!Active)
	{
