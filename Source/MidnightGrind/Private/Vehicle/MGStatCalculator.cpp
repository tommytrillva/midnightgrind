...
float UMGStatCalculator::EstimateZeroTo60(const FMGVehicleSpecs& Stats, const FMGDrivetrainConfiguration& Drivetrain)
{
...
float UMGStatCalculator::EstimateZeroTo100(const FMGVehicleSpecs& Stats, const FMGDrivetrainConfiguration& Drivetrain)
{
...
float UMGStatCalculator::EstimateQuarterMile(const FMGVehicleSpecs& Stats, const FMGDrivetrainConfiguration& Drivetrain)
{
...
float UMGStatCalculator::EstimateQuarterMileTrap(const FMGVehicleSpecs& Stats)
{
	// Trap speed formula
...
float UMGStatCalculator::EstimateTopSpeed(const FMGVehicleSpecs& Stats, const FMGDrivetrainConfiguration& Drivetrain, const FMGAeroConfiguration& Aero)
{
...
float UMGStatCalculator::CalculatePerformanceIndex(const FMGVehicleSpecs& Stats)
{
...
FMGVehicleSpecs UMGStatCalculator::CalculateAllStats(const FMGVehicleData& Vehicle, const UMGVehicleModelData* BaseModel)
{
	FMGVehicleSpecs Stats;
...
UMGPartDataAsset* UMGStatCalculator::GetPartData(FName PartID)
{
