...
void UMGFuelConsumptionComponent::TickComponent(float MGDeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
float UMGFuelConsumptionComponent::CalculateFrameConsumption(float MGDeltaTime)
{
	if (!MovementComponent)
	{
		return 0.0f;
...
void UMGFuelConsumptionComponent::UpdateDrivingStyleMetrics(float MGDeltaTime)
{
	if (!MovementComponent)
	{
		return;
...
void UMGFuelConsumptionComponent::UpdateFuelStarvation(float MGDeltaTime)
{
...
void UMGFuelConsumptionComponent::UpdateTelemetry(float MGDeltaTime, float FrameConsumption)
{
