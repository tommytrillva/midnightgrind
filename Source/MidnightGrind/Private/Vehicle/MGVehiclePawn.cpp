...
void AMGVehiclePawn::Tick(float MGDeltaTime)
{
...
void AMGVehiclePawn::PossessedBy(AController* NewController)
{
	...
	if (APlayerController* PC = Cast<APlayerController>(NewController))
	{
		if (UEnhancedInputLocalPlayerSubsystem* Subsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(PC->GetLocalPlayer()))
		{
			...
			{
				Subsystem->AddMappingContext(VehicleMappingContext, MGInputMappingPriority);
			}
		}
	}
}
...
void AMGVehiclePawn::UpdateRuntimeState(float MGDeltaTime)
{
	if (!MGVehicleMovement)
	{
		return;
...
void AMGVehiclePawn::UpdateCamera(float MGDeltaTime)
{
	if (!Camera || !SpringArm)
	{
		return;
...
void AMGVehiclePawn::UpdateAudio(float MGDeltaTime)
{
...
void AMGVehiclePawn::UpdateVFX(float MGDeltaTime)
{
