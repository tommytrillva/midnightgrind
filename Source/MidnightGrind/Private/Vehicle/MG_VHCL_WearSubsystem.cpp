...
void UMGVehicleWearSubsystem::UpdateWearFromGameplay(FGuid VehicleID, float MGDeltaTime, const FVector& Velocity,
...
void UMGVehicleWearSubsystem::ApplyTireWear(FGuid VehicleID, float WheelSlip, float Speed, bool bDrifting, float MGDeltaTime)
{
	FMGVehicleWearState* State = VehicleWearStates.Find(VehicleID);
	if (!State)
	{
...
void UMGVehicleWearSubsystem::ApplyEngineWear(FGuid VehicleID, float RPM, float MaxRPM, float Throttle, float MGDeltaTime)
{
	FMGVehicleWearState* State = VehicleWearStates.Find(VehicleID);
	if (!State)
	{
...
void UMGVehicleWearSubsystem::ApplyBrakeWear(FGuid VehicleID, float BrakeForce, float Speed, float MGDeltaTime)
{
	FMGVehicleWearState* State = VehicleWearStates.Find(VehicleID);
	if (!State)
	{
...
void UMGVehicleWearSubsystem::UpdateEngineState(FMGEngineWearData& Engine, float MGDeltaTime)
{
...
void UMGVehicleWearSubsystem::UpdateBrakeState(FMGBrakeWearData& Brakes, float MGDeltaTime)
{
	// Cool down brakes
