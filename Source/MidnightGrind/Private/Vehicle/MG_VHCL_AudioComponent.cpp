...
#include "Vehicle/MG_VHCL_AudioComponent.h"
...
void UMGVehicleAudioComponent::TickComponent(float MGDeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGVehicleAudioComponent::UpdateEngineSounds(float MGDeltaTime)
{
...
void UMGVehicleAudioComponent::UpdateTireSounds(float MGDeltaTime)
{
	if (!OwnerVehicle.IsValid())
	{
		return;
...
void UMGVehicleAudioComponent::UpdateWindSound(float MGDeltaTime)
{
...
void UMGVehicleAudioComponent::UpdateForcedInductionSounds(float MGDeltaTime)
{
	if (!OwnerVehicle.IsValid())
	{
		return;
...
void UMGVehicleAudioComponent::UpdateBackfires(float MGDeltaTime)
{
