...
void UMGDriftComboSystem::TickComponent(float MGDeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGDriftComboSystem::UpdateDriftScoring(float MGDeltaTime, float CurrentAngle, float CurrentSpeed)
{
