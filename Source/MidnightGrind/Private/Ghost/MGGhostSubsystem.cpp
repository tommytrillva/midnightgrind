...
void UMGGhostSubsystem::UpdatePlayback(float MGDeltaTime)
{
...
void UMGGhostSubsystem::FetchLeaderboard(FName TrackID, int32 StartRank, int32 Count)
{
	...
	Request->OnProcessRequestComplete().BindWeakLambda(this,
		[this, TrackID](FHttpRequestPtr Req, FHttpResponsePtr Resp, bool bSuccess)
		{
			...
			OnLeaderboardFetched.Broadcast(TrackID, Leaderboards.Contains(TrackID) ? Leaderboards[TrackID] : TArray<FMGGhostLeaderboardEntry>(), true);
		});
