...
void AMGRaceGameMode::Tick(float MGDeltaTime)
{
...
void AMGRaceGameMode::UpdateCountdown(float MGDeltaTime)
{
...
void AMGRaceGameMode::UpdateRaceTiming(float MGDeltaTime)
{
	RaceTime += DeltaTime;
