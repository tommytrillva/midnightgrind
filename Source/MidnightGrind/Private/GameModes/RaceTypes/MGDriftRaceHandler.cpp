...
void UMGDriftRaceHandler::OnRaceTick(float MGDeltaTime)
{
...
void UMGDriftRaceHandler::ProcessVehicleDrift(int32 RacerIndex, AMGVehiclePawn* Vehicle, float MGDeltaTime)
{
	if (!Vehicle)
	{
		return;
...
float UMGDriftRaceHandler::CalculateDriftPoints(const FMGActiveDrift& Drift, float MGDeltaTime) const
{
