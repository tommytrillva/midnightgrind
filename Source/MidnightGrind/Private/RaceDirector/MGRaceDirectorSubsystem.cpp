...
/**
 * @file MGRaceDirectorSubsystem.cpp
 * @brief Implementation of the Race Director Subsystem
 *
 * Contains the AI-driven race pacing and dramatic moment orchestration logic:
 * - Rubber-banding calculations and application
 * - AI behavior state management
 * - Dramatic moment detection and triggering
 * - Race phase progression
 * - Tension scoring
 * - Gap calculations
 * - Difficulty preset management
 *
 * @see MGRaceDirectorSubsystem.h for class documentation
 */
...
void UMGRaceDirectorSubsystem::UpdateDirector(float MGDeltaTime)
{
    if (!bRaceActive)
    {
        return;
