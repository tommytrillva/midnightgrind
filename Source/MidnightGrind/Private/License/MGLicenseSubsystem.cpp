...
/**
 * @file MGLicenseSubsystem.cpp
 * @brief Implementation of the Racing License and Driving School system.
 */
...
void UMGLicenseSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	// Initialize player licenses for each racing category with default (None) tier
