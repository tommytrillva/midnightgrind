...
/**
 * @file MGMemoryManagerSubsystem.cpp
 * @brief Implementation of the Memory Management, Asset Streaming, and Loading Optimization System
 */
...
void UMGMemoryManagerSubsystem::UpdateStreamingSettings(const FMGStreamingSettings& NewSettings)
{
