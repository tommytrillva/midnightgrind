...
/**
 * @file MGInputBufferSubsystem.cpp
 * @brief Implementation of frame-perfect input buffering for racing mechanics.
 *
 * @see MGInputBufferSubsystem.h for full documentation
 */
...
void UMGInputBufferSubsystem::ProcessInputFrame(float MGDeltaTime)
{
...
void UMGInputBufferSubsystem::UpdateActionStates(float MGDeltaTime)
{
...
void UMGInputBufferSubsystem::UpdateTimingWindows(float MGDeltaTime)
{
...
void UMGInputBufferSubsystem::ProcessPlayback(float MGDeltaTime)
{
    if (!bIsPlayingBack || bIsPlaybackPaused)
    {
        return;
