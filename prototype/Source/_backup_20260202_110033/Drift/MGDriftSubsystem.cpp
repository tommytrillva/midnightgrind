...
void UMGDriftSubsystem::UpdateDriftState(float DeltaTime, float SlipAngle, float Speed, const FVector& Position, const FVector& Velocity)
{
...
void UMGDriftSubsystem::CalculatePoints(float DeltaTime)
{
