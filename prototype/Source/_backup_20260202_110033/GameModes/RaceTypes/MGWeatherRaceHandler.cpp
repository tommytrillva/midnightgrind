...
void UMGWeatherRaceHandler::OnRaceTick(float DeltaTime)
{
...
void UMGWeatherRaceHandler::UpdateWeatherEffects(float DeltaTime)
{
...
void UMGWeatherRaceHandler::TrackAquaplaning(float DeltaTime)
{
	if (!WeatherRacingSubsystem.IsValid())
	{
		return;
