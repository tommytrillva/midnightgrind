...
struct FMGAudioSettings
{
	...
	/** Max concurrent engine sounds */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int32 MaxEngineSounds = 8;

	/** Max concurrent tire sounds */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int32 MaxTireSounds = 8;

	/** Max concurrent environment sounds */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int32 MaxEnvironmentSounds = 16;

	/** Audio quality level (0-3) */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int32 AudioQuality = 3;
	...
	/** Distance attenuation start (meters) */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	float AttenuationStart = 50.0f;

	/** Distance attenuation end (meters) */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	float AttenuationEnd = 200.0f;
};
