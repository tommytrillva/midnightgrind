...
/**
 * @brief A title that displays alongside the player's name.
 *
 * Titles are text labels (e.g., "Speed Demon", "Drift King") that players
 * can equip. Only one title can be active at a time.
 */
USTRUCT(BlueprintType)
struct FMGPlayerTitle
{
	...
	/// The actual title text displayed
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Title")
	FText DisplayText;

	/// Color used when rendering the title
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Title")
