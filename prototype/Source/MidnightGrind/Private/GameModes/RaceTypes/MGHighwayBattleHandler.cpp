...
void UMGHighwayBattleHandler::UpdateRace(float DeltaTime)
{
...
void UMGHighwayBattleHandler::UpdateParticipants(float DeltaTime)
{
	for (int32 i = 0; i < 2; ++i)
	{
...
void UMGHighwayBattleHandler::UpdateBattleState(float DeltaTime)
{
