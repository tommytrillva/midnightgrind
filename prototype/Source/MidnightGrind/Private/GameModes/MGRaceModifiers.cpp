...
void UMGRaceModifier::OnTick_Implementation(float DeltaTime)
{
...
void UMGModifier_UnlimitedNOS::OnTick_Implementation(float DeltaTime)
{
...
void UMGModifier_CatchUp::OnTick_Implementation(float DeltaTime)
{
	Super::OnTick_Implementation(DeltaTime);
...
void UMGModifier_Elimination::OnTick_Implementation(float DeltaTime)
{
	Super::OnTick_Implementation(DeltaTime);
...
void UMGModifier_TimeAttack::OnTick_Implementation(float DeltaTime)
{
	Super::OnTick_Implementation(DeltaTime);
...
void UMGModifier_Traffic::OnTick_Implementation(float DeltaTime)
{
	Super::OnTick_Implementation(DeltaTime);
...
void UMGModifier_DriftOnly::OnTick_Implementation(float DeltaTime)
{
	Super::OnTick_Implementation(DeltaTime);
...
void UMGModifier_RandomEvents::OnTick_Implementation(float DeltaTime)
{
	Super::OnTick_Implementation(DeltaTime);
...
void UMGRaceModifierManager::TickModifiers(float DeltaTime)
{
	for (const auto& Pair : ActiveModifiers)
	{
		if (Pair.Value)
