...
void UMGDefaultRaceOverlay::UpdateCountdownAnimation(float DeltaTime)
{
...
void UMGDefaultRaceOverlay::UpdateNotificationAnimations(float DeltaTime)
{
	if (!GetWorld())
	{
		return;
...
void UMGDefaultRaceOverlay::UpdateWrongWayAnimation(float DeltaTime)
{
...
void UMGDefaultRaceOverlay::UpdateFinishAnimation(float DeltaTime)
{
