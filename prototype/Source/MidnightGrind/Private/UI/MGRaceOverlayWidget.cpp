...
void UMGRaceOverlayWidget::UpdateCountdown(float DeltaTime)
{
...
void UMGRaceOverlayWidget::UpdateNotifications(float DeltaTime)
{
...
void UMGRaceOverlayWidget::UpdateWrongWayFlash(float DeltaTime)
{
	if (!bShowingWrongWay)
	{
		return;
