...
void UMGPostProcessSubsystem::UpdateEffects(float DeltaTime)
{
...
void UMGPostProcessSubsystem::UpdateTemporaryEffects(float DeltaTime)
{
    // Update glitch timer
...
void UMGPostProcessSubsystem::ProcessSpeedEffects(float Speed, float DeltaTime)
{
