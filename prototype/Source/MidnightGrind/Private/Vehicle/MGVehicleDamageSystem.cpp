...
void UMGVehicleDamageSystem::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGVehicleDamageSystem::UpdateAutoRepair(float DeltaTime)
{
...
void UMGVehicleDamageSystem::UpdateRepairs(float DeltaTime)
{
	for (auto& Pair : ComponentStates)
	{
		if (Pair.Value.bIsRepairing)
