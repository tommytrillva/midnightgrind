...
// Update
void UMGStreakSubsystem::UpdateStreakSystem(float DeltaTime)
{
	TickStreaks(DeltaTime);
}

// Protected
void UMGStreakSubsystem::TickStreaks(float DeltaTime)
{
	UpdateCombos(DeltaTime);
	CheckStreakExpirations();
}

void UMGStreakSubsystem::UpdateCombos(float DeltaTime)
{
