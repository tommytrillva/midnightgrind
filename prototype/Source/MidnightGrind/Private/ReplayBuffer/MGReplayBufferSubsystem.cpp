...
void UMGReplayBufferSubsystem::RecordFrame(float DeltaTime)
{
    if (CurrentState != EMGReplayState::Recording)
    {
        return;
...
void UMGReplayBufferSubsystem::UpdatePlayback(float DeltaTime)
{
    if (CurrentState != EMGReplayState::Playing)
    {
        return;
...
void UMGReplayBufferSubsystem::UpdateRecording(float DeltaTime)
{
