...
void UMGCollisionSubsystem::UpdateCollisionSystem(float DeltaTime)
{
...
void UMGCollisionSubsystem::TickCollision(float DeltaTime)
{
	UpdateCollisionSystem(DeltaTime);
}

void UMGCollisionSubsystem::UpdateInvincibility(float DeltaTime)
{
...
void UMGCollisionSubsystem::UpdateTakedownChains(float DeltaTime)
{
	TArray<FString> Expired;
...
void UMGCollisionSubsystem::UpdateFireDamage(float DeltaTime)
{
