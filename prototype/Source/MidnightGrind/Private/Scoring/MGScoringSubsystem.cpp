...
// Update
void UMGScoringSubsystem::UpdateScoringSystem(float DeltaTime)
{
...
// Protected
void UMGScoringSubsystem::TickChains(float DeltaTime)
{
...
void UMGScoringSubsystem::TickMultipliers(float DeltaTime)
{
