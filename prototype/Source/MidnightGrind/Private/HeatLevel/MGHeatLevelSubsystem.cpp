...
void UMGHeatLevelSubsystem::TickPursuit(float DeltaTime)
{
...
void UMGHeatLevelSubsystem::TickCooldown(float DeltaTime)
{
...
void UMGHeatLevelSubsystem::TickBounty(float DeltaTime)
{
