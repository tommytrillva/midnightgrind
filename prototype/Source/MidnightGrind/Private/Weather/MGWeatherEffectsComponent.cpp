...
void UMGWeatherEffectsComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGWeatherEffectsComponent::UpdateWindshieldEffects(float DeltaTime)
{
	if (!WeatherSubsystem)
	{
		return;
...
void UMGWeatherEffectsComponent::UpdateWipers(float DeltaTime)
{
	if (WiperMode == 0)
	{
		return;
...
void AMGWeatherEffectActor::Tick(float DeltaTime)
{
...
void UMGRoadSurfaceEffectComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	Super::TickComponent(DeltaTime, TickType, ThisTickFunction);
