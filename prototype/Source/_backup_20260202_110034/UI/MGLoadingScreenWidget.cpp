...
void UMGLoadingScreenWidget::UpdateProgressAnimation(float DeltaTime)
{
	// Smooth progress bar
...
void UMGLoadingScreenWidget::UpdateTipRotation(float DeltaTime)
{
...
void UMGLoadingScreenWidget::UpdateBackgroundAnimation(float DeltaTime)
{
