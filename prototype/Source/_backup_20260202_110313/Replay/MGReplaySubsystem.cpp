...
void UMGReplaySubsystem::Tick(float DeltaTime)
{
	switch (CurrentState)
	{
...
void UMGReplaySubsystem::UpdateRecording(float DeltaTime)
{
...
void UMGReplaySubsystem::UpdatePlayback(float DeltaTime)
{
	if (!CurrentPlaybackData.IsValid())
	{
		StopPlayback();
...
void UMGReplaySubsystem::UpdateGhosts(float DeltaTime)
{
