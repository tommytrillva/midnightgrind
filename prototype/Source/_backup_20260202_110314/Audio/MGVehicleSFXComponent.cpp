...
void UMGVehicleSFXComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UMGVehicleSFXComponent::UpdateTireSounds(float DeltaTime)
{
	if (bIsAirborne)
	{
...
void UMGVehicleSFXComponent::UpdateWindNoise(float DeltaTime)
{
...
void UMGVehicleSFXComponent::UpdateBrakeSounds(float DeltaTime)
{
	if (!BrakeComponent)
	{
		return;
